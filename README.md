...
**Budget App** - in this application you can select a category and within it you can save multiple objects that refer to this category.
...
- **Use Rails forms to add categories, and payments**
...
```sh
  $ https://github.com/jdbs9514/budget-app.git
```
